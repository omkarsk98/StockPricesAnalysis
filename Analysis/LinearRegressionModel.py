...
plt.plot(dates[900:], result["labelsMean"]*test_labels, color="green", linewidth=2)
plt.plot(dates[900:], ((result["featuresMean"].astype(float))*features[900:])[:,5], color="red", linewidth=2)
